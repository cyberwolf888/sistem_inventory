        ...
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="{{ route('backend.kategori.manage') }}" class="kt-subheader__breadcrumbs-link">
                        Kategori
                    </a>
                    <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        {!! Form::open(['route' => isset($update) ? ['backend.kategori.update', $model->id] :'backend.kategori.store', 'method' => 'post', 'class'=>'kt-form']) !!}
                            ...
                            <div class="kt-portlet__foot">
                                <div class="kt-form__actions">
                                    ...
                                    <a href="{{ route('backend.kategori.manage') }}" class="btn btn-secondary">Batal</a>
                                </div>
                            </div>
                        {!! Form::close() !!}
                        <!--end::Form-->
